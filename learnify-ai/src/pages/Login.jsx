  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-white text-slate-900">
        ...
        <section className="px-10 md:px-20 py-20 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-blue-50 rounded-[30px] p-8 shadow-xl border border-blue-100">
            <div className="bg-white rounded-3xl p-6 shadow-lg">
              <h2 className="font-bold text-xl mb-2">Welcome back, Student 👋</h2>
              <p className="text-slate-500 text-sm mb-6">Let’s make today productive!</p>
              ...
              <div className="grid grid-cols-4 gap-4 mb-6">
                {[
                  ...
                  <div key={item[0]} className="border border-slate-200 rounded-2xl p-4">
              ...
              <div className="bg-slate-50 rounded-2xl p-5">
                ...
                <p className="text-slate-600 mb-5">How can I help you today?</p>
                <div className="flex gap-3">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-6">
        <div className="w-full max-w-[430px] bg-white/95 border border-slate-200 rounded-[28px] shadow-2xl p-10">
